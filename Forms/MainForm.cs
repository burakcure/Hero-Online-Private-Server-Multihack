...
namespace OSPE
{
    public partial class MainForm : Form
    {
        ...
        private void StartCapture(bool damageHack)
        {
            if (!_isPaused)
                ClearPacketLists();
            _isPaused = false;
        ...
        private void kingofAA_CheckedChanged(object sender, EventArgs e)
        {
            PacketManager.damageHack = kingofAA.Checked;
        }

        private void skillDamageHack_CheckedChanged(object sender, EventArgs e)
        {
            PacketManager.skillDamageHack = skillDamageHack.Checked;
        }
    }
}
